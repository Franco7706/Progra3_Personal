	...
	public class FichaEvaluacion {
		...
		public Estado Estado_candidato{
			get{
				...
				if(puntaje_total > FichaEvaluacion.PUNTAJE_MINIMO){
		...
		public FichaEvaluacion(Postulante candidato, DateTime fecha_hora, 
		int evaluacion_expediente, int evaluacion_entrevista, int evaluacion_examen,
